...
<body>
                    ...
                    <div class="carousel-cell">
                        <div class="main-header-carousel-nav">
                            ...
                            <ul>
                                ...
                                <li><i class="fal fa-caret-right" aria-hidden="true"></i>SalesForce</li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row justify-content-start mt-10">
                ...
                <div class="col-md-6 col-12">
                    <div class="section_text_graphic_image" style="background-color: #fff;">
                        <img src="../img/demo/features/Conexion.gif" class="d-block mx-lg-auto img-fluid mt-n10 mb-15"
                            alt="Bootstrap Themes" width="640" height="584" loading="lazy" />
                    </div>
                </div>
            </div>
            <div class="row justify-content-start mt-10">
                <div class="col-md-6 col-12">
                    <div style="background-color: transparent;" class="section_text_graphic_image">
                        <img src="../img/demo/features/Seccion5.1.png" alt="PUBLICIDAD ANALOGA Y DIGITAL"
                            title="PUBLICIDAD ANALOGA Y DIGITAL" loading="lazy">
                    </div>
                </div>
                <div class="col-md-6 col-12 d-flex align-items-center">
                    <div class="content-text-author mt-md-0 mt-14">
            ...
            <div class="row justify-content-start mt-10" id="asignacion">
                ...
                <div class="col-md-6 col-12">
                    <div style="background-color: #fff;" class="section_text_graphic_image">
                        <img src="../img/demo/features/Seccion4.jpg" alt="ENLACE VENTAS" title="ENLACE CON TUS VENTAS"
                            loading="lazy" />
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6 col-12 d-flex align-items-center">
                    <div class="content-text-author mb-md-0 mb-14">
                        ...
                        <a role="button" class="href-button" id="header-login-dropdown" aria-haspopup="true" aria-expanded="false"
                         href="data-reports.php">Conoce más</a>
                    </div>
                </div>
                <div class="col-md-6 col-12">
                    <div style="background-color: #19d3c5;" class="section_text_graphic_image">
                        <img src="../img/demo/features/Seccion6-graph.png" alt="PODER DATOS" title="PODER DE LOS DATOS"
                            loading="lazy" />
                    </div>
                </div>
            </div>
    ...
    <section class="pt-10 py-15 bg-default-2">
        <div class="container">
            ...
            <div class="row justify-content-center mr-tp-40">
                <div class="col-md-3">
                    <div class="box-features-one">
                        <i src="../img/demo/features/Duplicidad.png"><img src="../img/demo/features/Duplicidad.png"
                ...
                <div class="col-md-3">
                    <div class="box-features-one">
                        <i src="../img/demo/features/Ruleta.png"><img src="../img/demo/features/Ruleta.png"
                ...
                <div class="col-md-3">
                    <div class="box-features-one">
                        <i src="../img/demo/features/Iscore.png"><img src="../img/demo/features/Iscore.png"
                                style="height: 100%; width: auto;" alt="CALIFICA CON ISCORE"
                ...
                <div class="col-md-3">
                    <div class="box-features-one">
                        <i src="../img/demo/features/Score.png"><img src="../img/demo/features/Score.png"
            ...
            <div class="row justify-content-center mr-tp-10">
                ...
                <div class="col-md-3">
                    <div class="box-features-one">
                        <i src="../img/demo/features/Quality.png"><img src="../img/demo/features/Quality.png"
                ...
                <div class="col-md-3">
                    <div class="box-features-one">
                        <i src="../img/demo/features/Acortador de Ligas.png"><img
        ...
        <div class="container">
            <div class="carousel-main-customers-container mr-tp-40 d-flex mx-auto flex-column">
                ...
                <div class="carousel-nav-customers-text">
                    ...
                    <div class="carousel-cell">
                        <div class="carousel-customrs-holder">
                            <img src="../img/evas/Charlie.png" alt="EVANGELIST PRODUCT" title="EVANGELIST PRODUCT">
                        </div>
                    </div>

                    <div class="carousel-cell">
                        <div class="carousel-customrs-holder">
                            <img src="../img/evas/Mau.png" alt="EVANGELIST PRODUCT" title="EVANGELIST PRODUCT">
                        </div>
                    </div>

                    <div class="carousel-cell d-none">
                        <div class="carousel-customrs-holder">
                            <img src="../img/demo/faces/member6.jpg" alt="EVANGELIST PRODUCT" title="EVANGELIST PRODUCT">
                        </div>
                    </div>
    ...
    <section class="pt-10 pb-10">
        <div class="container">
            <div class="row justify-content-start">
                ...
                <div class="col-md-6 col-12">
                    <div style="background-color: transparent;" class="section_text_graphic_image">
                        <img src="../img/demo/features/ContinenteAmericano.png" alt="PRESENCIA EN AMERICA"
                            title="PRESENCIA EN AMERICA" loading="lazy">
                    </div>
                </div>
            </div>
    ...
    <section class="our-pertners pt-12 pb-12">
        <div class="container">
            <h5 class="title-default-coodiv-two">Familia DragonCEM<span class="mr-tp-10">La calidad de DragonCEM respaldada por la importancia de nuestros clientes</span></h5>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="padding-top: 0;">
                    <div class="row" style="padding-bottom: 1.5rem;">
                        <div class="col-md-8">
                            <form class="form-contain-home contact-page-form-send" style="padding: 0;" method="post"
                                action="../mailer-modal.php" id="ajax-contact-modal" style="box-shadow: none; margin: 0;"
                                ...
                                <input type="hidden" name="origen" id="origen" value="es-MX" />
                        ...
                        <div class="col-md-4 d-flex flex-column justify-content-center align-items-center border"
                            ...
                            <div class="border-container-qr" style="animation-delay: 1500ms;">
                                <div class="border-container-qr" style="animation-delay: 1000ms;">
                                    <div class="border-container-qr" style="animation-delay: 500ms;">
                                        <img src="../img/dragoncem-qr.jpg" alt="QR Code" style="border-radius: .5rem;">
                                    </div>
                                </div>
