            ...
            <ul class="main-header-features">
              <li>
                ...
                <div class="d-flex justify-content-start"><a class="main-header-btn coodiv-text-9 font-weight-bold"
                    href="index.php" id="botonGoBack">Go back <i class="fal fa-arrow-left"></i></a></div>

              </li>
            </ul>
          </div>
          <div class="col-md-6 col-12">
            <img src="../img/demo/features/MauIsotipo.gif" class="d-block mx-lg-auto img-fluid mt-n10 mb-15"
