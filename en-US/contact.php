...
<head>
    ...
    <meta property="og:title" content="DragonCEM | Contact - US" />
        ...
        <main class="container mt-25">
            ...
            <div class="row">
                <div class="col-md-5 pt-15">
                    <span class="main-header-top-title">Do you have any questions about DragonCEM?</span>
                    <h3 class="mt-3 contact-us-hero-title coodiv-text-3" style="color:#003462;">Send us a message.</h3>
                ...
                <div class="col-md-7">
                    <form class="row form-contain-home contact-page-form-send" id="ajax-contact" method="post"
                        action="../mailer.php">
                        <!-- start form -->
                        <h5>Contact Us<span>Technology is advancing, and you?</span>
                            <span>Join us and always stay one step ahead.</span>
                        </h5>
    ...
    <section class="padding-20-0 mob-display-none">
        <div class="container">
            <div class="row justify-content-start">
                <div class="col-md-5">
                    <h5 class="immediate-help-center-title">Get a personalized quote.</h5>
                    <p class="immediate-help-center-text">Call us to:</p>
